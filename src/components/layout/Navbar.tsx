        ...
        <div className="flex items-center gap-4 group">
          ...
          <div className="flex flex-col h-9 justify-center">
            <Link href="/" className="flex flex-col group-hover:opacity-80 transition-opacity">
              <span className="text-lg font-black tracking-tighter text-white leading-none">硅基大宗</span>
              <div className="flex items-center gap-1.5 mt-0.5">
                <span className="text-cyan-500/50 text-[8px] uppercase tracking-[0.2em] font-mono leading-none">AI Intelligence</span>
                <span className="w-0.5 h-0.5 bg-cyan-500/20 rounded-full"></span>
                <span className="text-cyan-500 text-[8px] uppercase tracking-[0.3em] font-black leading-none italic">Terminal</span>
              </div>
            </Link>
          </div>
        </div>
