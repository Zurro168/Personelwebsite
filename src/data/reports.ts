...
export const ALL_REPORTS: Report[] = [
  {
    ...
    description: '通过逻辑还原美元周期与实物资产的负相关性，揭示宏观货币流动性在大宗定价中的霸权地位。',
    tag: '宏观觉悟',
    date: '2026-04-13',
    readTime: '15 min',
  ...
  },
  {
    ...
    description: '深度剖析加蓬锰矿政策变动逻辑，透视全球资源民族主义背景下的产业主权转移。',
    tag: '宏观觉悟',
    date: 'Sat Apr 11 2026 08:00:00 GM',
    readTime: '15 min',
    image: 'https://images.unsplash.com/photo-1579546929518-9e396f3cc809?q=80&w=1200&auto=format&fit=crop',
  ...
  },
  {
    ...
    tag: '硬核商品',
    date: 'Fri Apr 17 2026 08:00:00 GM',
    readTime: '12 min',
    image: 'https://images.unsplash.com/photo-1579546929518-9e396f3cc809?q=80&w=1200&auto=format&fit=crop',
